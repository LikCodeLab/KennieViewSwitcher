...
public class Constant {
    ...
    public static final double BOUNCE_ANIM_AMPLITUDE_IN = 0.2;
    public static final double BOUNCE_ANIM_AMPLITUDE_OUT = 0.15;
    public static final double BOUNCE_ANIM_FREQUENCY_IN = 14.5;
    public static final double BOUNCE_ANIM_FREQUENCY_OUT = 12.0;
